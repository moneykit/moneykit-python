...
class TestGetAccountNumbersResponse(unittest.TestCase):
    """GetAccountNumbersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountNumbersResponse:
        """Test GetAccountNumbersResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetAccountNumbersResponse`
        """
        model = GetAccountNumbersResponse()
        if include_optional:
            return GetAccountNumbersResponse(
                accounts = [
                    moneykit.models.account_with_account_numbers.AccountWithAccountNumbers(
    ...
    def testGetAccountNumbersResponse(self):
        """Test GetAccountNumbersResponse"""

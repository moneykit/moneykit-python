...
RESPONSE401DELETELINKLINKSIDDELETE_ANY_OF_SCHEMAS = [
    "APIErrorAuthExpiredAccessTokenResponse",
    "APIErrorAuthUnauthorizedResponse",
    "LinkErrorUnauthorizedAccessResponse",
]
...
class Response401DeleteLinkLinksIdDelete(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Response401DeleteLinkLinksIdDelete.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in Response401DeleteLinkLinksIdDelete with anyOf schemas: APIErrorAuthExpiredAccessTokenResponse, APIErrorAuthUnauthorizedResponse, LinkErrorUnauthorizedAccessResponse. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into Response401DeleteLinkLinksIdDelete with anyOf schemas: APIErrorAuthExpiredAccessTokenResponse, APIErrorAuthUnauthorizedResponse, LinkErrorUnauthorizedAccessResponse. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
